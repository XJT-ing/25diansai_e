...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(ganwei_huidu_GRAY_AD0_PORT, ganwei_huidu_GRAY_AD0_PIN)) : (DL_GPIO_clearPins(ganwei_huidu_GRAY_AD0_PORT, ganwei_huidu_GRAY_AD0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(ganwei_huidu_GRAY_AD1_PORT, ganwei_huidu_GRAY_AD1_PIN)) : (DL_GPIO_clearPins(ganwei_huidu_GRAY_AD1_PORT, ganwei_huidu_GRAY_AD1_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(ganwei_huidu_GRAY_AD2_PORT, ganwei_huidu_GRAY_AD2_PIN)) : (DL_GPIO_clearPins(ganwei_huidu_GRAY_AD2_PORT, ganwei_huidu_GRAY_AD2_PIN)))// 地址位2控制
...
#ifndef Use_Timer
// 任务处理函数
void No_Mcu_Ganv_Sensor_Task_Without_tick(No_MCU_Sensor* sensor,unsigned short *result); // 无时基版本
...
void GetDigital(unsigned short *adc_value,unsigned short *Gray_white,unsigned short *Gray_black,unsigned short *result);
